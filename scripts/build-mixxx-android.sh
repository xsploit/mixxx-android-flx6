...
if ! grep -qE 'android:versionName="0\.(16\.0-five-pixel-header-guard|17\.0-measured-header-layout)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(6\.0-android-storage|7\.0-live-layout|8\.0-native-waveform-split|9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height|12\.0-fixed-waveform-stack|13\.0-draggable-waveform-stack|14\.0-clipped-waveform-lanes|15\.0-layered-adjustable-waveforms)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(7\.0-live-layout|8\.0-native-waveform-split|9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height|12\.0-fixed-waveform-stack|13\.0-draggable-waveform-stack|14\.0-clipped-waveform-lanes|15\.0-layered-adjustable-waveforms)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(8\.0-native-waveform-split|9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height|12\.0-fixed-waveform-stack|13\.0-draggable-waveform-stack|14\.0-clipped-waveform-lanes|15\.0-layered-adjustable-waveforms)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height|12\.0-fixed-waveform-stack|13\.0-draggable-waveform-stack|14\.0-clipped-waveform-lanes|15\.0-layered-adjustable-waveforms)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(10\.0-safe-area-viewports|11\.0-visible-window-height|12\.0-fixed-waveform-stack|13\.0-draggable-waveform-stack|14\.0-clipped-waveform-lanes|15\.0-layered-adjustable-waveforms)"' packaging/android/AndroidManifest.xml; then
    apply_patch_if_needed "${REPO_DIR}/patches/mixxx-android-v0.10-safe-area-viewports.patch"
fi
if ! grep -qE 'android:versionName="0\.(11\.0-visible-window-height|12\.0-fixed-waveform-stack|13\.0-draggable-waveform-stack|14\.0-clipped-waveform-lanes|15\.0-layered-adjustable-waveforms)"' packaging/android/AndroidManifest.xml; then
    apply_patch_if_needed "${REPO_DIR}/patches/mixxx-android-v0.11-visible-window-height.patch"
fi
if ! grep -qE 'android:versionName="0\.(12\.0-fixed-waveform-stack|13\.0-draggable-waveform-stack|14\.0-clipped-waveform-lanes|15\.0-layered-adjustable-waveforms)"' packaging/android/AndroidManifest.xml; then
    apply_patch_if_needed "${REPO_DIR}/patches/mixxx-android-v0.12-fixed-waveform-stack.patch"
fi
if ! grep -qE 'android:versionName="0\.(13\.0-draggable-waveform-stack|14\.0-clipped-waveform-lanes|15\.0-layered-adjustable-waveforms)"' packaging/android/AndroidManifest.xml; then
    apply_patch_if_needed "${REPO_DIR}/patches/mixxx-android-v0.13-draggable-waveform-stack.patch"
fi
if ! grep -qE 'android:versionName="0\.(14\.0-clipped-waveform-lanes|15\.0-layered-adjustable-waveforms)"' packaging/android/AndroidManifest.xml; then
    apply_patch_if_needed "${REPO_DIR}/patches/mixxx-android-v0.14-clipped-waveform-lanes.patch"
fi
if ! grep -q 'android:versionName="0.15.0-layered-adjustable-waveforms"' packaging/android/AndroidManifest.xml; then
...
if ! grep -q 'android:versionName="0.17.0-measured-header-layout"' packaging/android/AndroidManifest.xml; then
