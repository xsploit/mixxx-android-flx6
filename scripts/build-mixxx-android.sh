...
if ! grep -qE 'android:versionName="0\.(3\.0-active-phone-ui|4\.0-performance-view|5\.0-waveform-fix|6\.0-android-storage|7\.0-live-layout|8\.0-native-waveform-split|9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(4\.0-performance-view|5\.0-waveform-fix|6\.0-android-storage|7\.0-live-layout|8\.0-native-waveform-split|9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height)"' packaging/android/AndroidManifest.xml; then
    apply_patch_if_needed "${REPO_DIR}/patches/mixxx-android-v0.4-performance-view.patch"
fi
if ! grep -qE 'android:versionName="0\.(5\.0-waveform-fix|6\.0-android-storage|7\.0-live-layout|8\.0-native-waveform-split|9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(6\.0-android-storage|7\.0-live-layout|8\.0-native-waveform-split|9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(7\.0-live-layout|8\.0-native-waveform-split|9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(8\.0-native-waveform-split|9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(9\.0-collapsible-toolbar|10\.0-safe-area-viewports|11\.0-visible-window-height)"' packaging/android/AndroidManifest.xml; then
...
if ! grep -qE 'android:versionName="0\.(10\.0-safe-area-viewports|11\.0-visible-window-height)"' packaging/android/AndroidManifest.xml; then
    apply_patch_if_needed "${REPO_DIR}/patches/mixxx-android-v0.10-safe-area-viewports.patch"
fi
if ! grep -q 'android:versionName="0.11.0-visible-window-height"' packaging/android/AndroidManifest.xml; then
