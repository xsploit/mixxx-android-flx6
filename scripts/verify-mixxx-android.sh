...
"$aapt" dump badging "$apk" | grep "package: name='org.mixxx.flx6standalone' versionCode='11' versionName='0.11.0-visible-window-height'" >/dev/null
"$aapt" dump badging "$apk" | grep "application-label:'Mixxx FLX6 v0.11'" >/dev/null
